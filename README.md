...
**NEW**: SRKoine is now on the CrossWire repository!  In your favourite SWORD-based app, just search the Bibles for SRKoine under "Greek, Ancient [to 1453] (Ἑλληνική)" and install it.
